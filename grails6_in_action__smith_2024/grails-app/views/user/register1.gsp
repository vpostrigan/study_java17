...
<g:hasErrors>
    <div class="errors">
        <g:renderErrors bean="${userSave}" as="list" />
    </div>
</g:hasErrors>
...
<!-- Listing 8.2 New registration form demonstrating core form tags -->
<h3>Register1</h3>
<g:uploadForm action="register1"> <!-- All Grails forms start with a g:form or g:uploadForm -->
    <fieldset class="form">
