...
/**
 * Service that provides some simple image manipulation to support the image controller.
 * The code has been factored out of ImageController, but this service is not in the book.
 */
class ImageService {
