...
we have also included some plain Groovy scripts in this directory.
...
*Note* CopingWithLineBreaks.groovy doesn't compile. This is intentional!
The file includes explanations on how to fix the compilation errors and why they occur.
