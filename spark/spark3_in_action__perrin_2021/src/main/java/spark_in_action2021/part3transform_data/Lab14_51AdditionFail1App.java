 ...
 * @author jgp
 */
public class Lab14_51AdditionFail1App {

    public static void main(String[] args) {
        Lab14_51AdditionFail1App app = new Lab14_51AdditionFail1App();
        app.start();
    }
    ...
    private void start() {
        ...
        spark
                .udf()
                .register("add", new Lab14_51IntegerAdditionUdf(), DataTypes.IntegerType);
        spark
                .udf()
                .register("add", new Lab14_51StringAdditionUdf(), DataTypes.StringType);
...
Exception in thread "main" org.apache.spark.SparkException: Failed to execute user defined function(UDFRegistration$$Lambda$825/0x00000008007e6840: (int, int) => string)
	...
	at spark_in_action2021.part3transform_data.Lab14_51AdditionFail1App.start(Lab14_51AdditionFail1App.java:69)
	at spark_in_action2021.part3transform_data.Lab14_51AdditionFail1App.main(Lab14_51AdditionFail1App.java:26)
Caused by: java.lang.ClassCastException: class java.lang.Integer cannot be cast to class java.lang.String (java.lang.Integer and java.lang.String are in module java.base of loader 'bootstrap')
	at spark_in_action2021.part3transform_data.Lab14_51StringAdditionUdf.call(Lab14_51StringAdditionUdf.java:5)
