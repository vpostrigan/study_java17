 ...
 * <p>
 * Look CSV issue with line in output
 * '17,9,Java 8 in Action: Lambdas, Streams, and functional-style programming,8/28/14,http://amzn.to/2isdqoL'
 *
 * @author jgp
 */
public class Lab15_61AuthorsAndBooksCountBooksApp {

    public static void main(String[] args) {
        Lab15_61AuthorsAndBooksCountBooksApp app = new Lab15_61AuthorsAndBooksCountBooksApp();
        app.start();
    }
...
/*
2022-11-05 12:58:46.446 - INFO --- [           main] til.Version.logVersion(Version.java:133): Elasticsearch Hadoop v7.17.3 [e52f4f523a]
+---+-------------------+--------------------+--------------------+
