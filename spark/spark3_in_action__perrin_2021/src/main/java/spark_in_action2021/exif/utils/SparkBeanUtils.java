...
public class SparkBeanUtils {
    ...
    /**
     * Returns a Spark datatype from the method, by analyzing the method's return type.
     */
     ...
     * This method should be improved to ensure name unicity.
     */
    ...
    public static Row getRowFromBean(Schema schema, Object bean) {
        ...
        for (String s : fieldName) {
            String methodName = schema.getMethodName(s);
            Method method;
            try {
