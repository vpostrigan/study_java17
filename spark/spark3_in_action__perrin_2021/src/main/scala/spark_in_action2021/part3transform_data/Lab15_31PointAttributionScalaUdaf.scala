...
class Lab15_31PointAttributionScalaUdaf extends UserDefinedAggregateFunction {

  private val log = LoggerFactory.getLogger(classOf[Lab15_31PointAttributionScalaUdaf])
