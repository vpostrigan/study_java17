 ...
 * @author rambabu.posa
 */
object Lab14_51AdditionFail1ScalaApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.udf.register("add", new Lab14_51IntegerAdditionScalaUdf, DataTypes.IntegerType)
    spark.udf.register("add", new Lab14_51StringAdditionScalaUdf, DataTypes.StringType)
...
Exception in thread "main" org.apache.spark.SparkException: Failed to execute user defined function(UDFRegistration$$Lambda$825/0x00000008007e2840: (int, int) => string)
	...
	at spark_in_action2021.part3transform_data.Lab14_51AdditionFail1ScalaApp$.main(Lab14_51AdditionFail1ScalaApp.scala:40)
	at spark_in_action2021.part3transform_data.Lab14_51AdditionFail1ScalaApp.main(Lab14_51AdditionFail1ScalaApp.scala)
Caused by: java.lang.ClassCastException: class java.lang.Integer cannot be cast to class java.lang.String (java.lang.Integer and java.lang.String are in module java.base of loader 'bootstrap')
	at spark_in_action2021.part3transform_data.Lab14_51StringAdditionScalaUdf.call(Lab14_51StringAdditionScalaUdf.scala:6)
