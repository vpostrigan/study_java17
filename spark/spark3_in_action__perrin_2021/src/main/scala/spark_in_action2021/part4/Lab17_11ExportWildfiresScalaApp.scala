 ...
 * @author rambabu.posa
 */
class Lab17_11ExportWildfiresScalaApp {

  val Modis_File = "MODIS_C6_Global_24h.csv"
  val Viirs_File = "VNP14IMGTDL_NRT_Global_24h.csv"
  val Tmp_Storage = "/tmp"

  private val log = LoggerFactory.getLogger(classOf[Lab17_11ExportWildfiresScalaApp])
...
object ExportWildfiresScalaApplication {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val app = new Lab17_11ExportWildfiresScalaApp
    app.start
