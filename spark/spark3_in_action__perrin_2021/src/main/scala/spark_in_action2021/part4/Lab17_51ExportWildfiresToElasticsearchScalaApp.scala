 ...
 *
 */
class Lab17_51ExportWildfiresToElasticsearchScalaApp {
  private val log = LoggerFactory.getLogger(classOf[Lab17_51ExportWildfiresToElasticsearchScalaApp])
...
object ExportWildfiresToElasticsearchScalaApplication {
  ...
  def main(args: Array[String]): Unit = {
    val app = new Lab17_51ExportWildfiresToElasticsearchScalaApp
    app.start
  }
